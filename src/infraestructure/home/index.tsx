        ...
        <div id='home' className="relative w-full flex flex-col justify-center items-center bg-red sm:py-82 py-80">
          <BackgroundSvg className="absolute h-full -z-10"/>
            ...
            <div className="w-[350px] md:w-[600px] text-center">
                <p className="py-2 font-normal text-lg">A Result-Oriented Web Developer building and managing Websites and Web Applications that leads to the success of the overall product</p>
            </div>
